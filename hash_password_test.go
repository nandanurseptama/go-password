...
func TestHashing(t *testing.T) {
	...
	sha256HashedString, err := HashMethodSHA256.Hashing(plainString)
	...
	sha1HashedString, err := HashMethodSHA1.Hashing(plainString)
	...
	sha512HashedString, err := HashMethodSHA512.Hashing(plainString)
